...
import ru.mirea.volegov.yandexmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int fLOCATION = ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION);
        int сLOCATION = ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION);
        ...
        if (fLOCATION == PackageManager.PERMISSION_GRANTED || сLOCATION == PackageManager.PERMISSION_GRANTED)
        {
    ...
    public void onObjectAdded(@NonNull UserLocationView userLocationView) {
        ...
        pinIcon.setIcon(
                "pin",
                ImageProvider.fromResource(this, R.drawable.myposition),
